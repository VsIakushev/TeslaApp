...
struct ChargingView: View {
    ...
    @State private var chargingProgress: CGFloat = 0.7
    @State private var isSuperchargersExpanded = false
    // TODO: - This is example. It hould be changed
    ...
    private var chargingGoals: some View {
        VStack {
            HStack {
                Spacer()
                Rectangle()
